    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('targetdb', models.CharField(choices=[('afted', 'afted'), ('scope95', 'scope95'), ('scope40', 'scope40'), ('cath40', 'cath40'), ('ecod70', 'ecod70'), ('pdb100', 'pdb100'), ('af21org', 'af21org')], default='afted', help_text="Choose a database to search against. afted is the <a href='https://www.biorxiv.org/content/10.1101/2024.03.18.585509'>TED domains</a> from the AlphaFold database. scope95/scope40/cath40/ecod70 are domains from classifications of the PDB. pdb100 is the whole PDB split into domains with Chainsaw. af21org is domains from the AlphaFold set of 21 model organisms. See <a href='https://github.com/greener-group/progres#available-databases'>here</a> for more info.", max_length=20, verbose_name='Target database')),
                ...
                ('maxhits', models.IntegerField(default=100, help_text='The maximum number of hits per domain to return. Hits will only be returned if they are above the minimum score given above. Must be 1 -> 1000.', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(1000)], verbose_name='Max number of hits')),
